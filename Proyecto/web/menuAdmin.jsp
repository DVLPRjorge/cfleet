...
<body background="imgtrucks.jpg" >
    <form action="Control" method="POST">
        <input type="hidden" name="pagina" value="menuAdmin">
        ...
        <div class="container">                    
            ...
            <form name="IrConsultarUsu" action="usuarioConsultaTot.jsp" method="POST">
                <input type="submit" name="bConsultarUsu" value="Consultar Usuarios" style=" width:100%">            
            </form>  
            ...
            <form name="IrConsultarVeh" action="vehiculosConsultaTot.jsp" method="POST">
                <input type="submit" name="bConsultarVeh" value="Consultar Vehiculos" style=" width:100%"> 
            </form>
